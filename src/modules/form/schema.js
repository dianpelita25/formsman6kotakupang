...
export const formFields = [
  ...
  },
  {
    ...
    name: 'q2',
    label:
      '2. Sejauh mana Anda memahami konsep Higher Order Thinking Skills (HOTS) sebelum kegiatan ini?',
    required: true,
  ...
  },
  {
    ...
    name: 'q7',
    label:
      '7. AI Teaching Assistant berpotensi membantu dalam pembuatan soal HOTS secara otomatis.',
    required: true,
    fromLabel: 'Sangat Tidak Setuju',
    toLabel: 'Sangat Setuju',
  },
  {
    ...
    name: 'q8',
    label:
      '8. Saya merasa terbantu dengan adanya fitur AI Teaching Assistant untuk pengembangan soal HOTS.',
    required: true,
  ...
  },
  {
    ...
    name: 'q9',
    label:
      '9. Saya siap mencoba mengimplementasikan AI Teaching Assistant dalam pembuatan soal HOTS di kelas.',
    required: true,
